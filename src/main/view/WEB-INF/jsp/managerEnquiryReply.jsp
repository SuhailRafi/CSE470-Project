...
<font color="green" size="6px">${ok}</font>
	<div class="container">
		<f:form method="POST" modelAttribute="enq">
			<table style="border-collapse: separate; border-spacing: 0 15px;">
				<tr>
					<td><b>Complaint Id:</b></td><td><f:input style="width: 150px;"
							type="text" name="enquiryId" path="enquiryId" class="form-control"
							required="required" /></td>
					<td><f:errors path="enquiryId" cssClass="text-warning" /></td>
					</tr>
					<tr>
					<td><b>Package Id:</b></td><td><f:input style="width: 150px;"
							type="text" name="packageId" path="packageId" class="form-control"
							required="required" /></td>
					<td><f:errors path="packageId" cssClass="text-warning" /></td>
				</tr>
				<tr>
					<td><b>User Id:</b></td><td><f:input style="width: 350px;"
				...
				<tr>
					...
					<f:textarea rows="6" cols="10" style="width: 350px;" type="text" name="enquiryReply"
							path="enquiryReply" class="form-control"
							required="required" /></td>
				</tr>
					<tr>
