...
<font color="green" size="6px">${success}</font>
	...
	<div class="container">
		...
		<f:form method="POST" modelAttribute="feedback">
			...
			<tr>
				...
				<tr>
					<td><b>Question 1:</b> <f:input style="width: 350px;"
							type="text" name="feedback1" path="question1"
							class="form-control" required="required" /></td>
				</tr>
				<tr>
					<td><b>Question 2:</b> <f:input style="width: 350px;"
							type="text" name="feedback2" path="question2" class="form-control"
							required="required" /></td>
				</tr>
				<tr>
					<td><b>Question 3:</b> <f:input style="width: 350px;"
							type="tel" name="feedback3" path="question3" class="form-control"
							required="required" /></td>
				<tr>
					<td><b>Question 4:</b> <f:input style="width: 350px;"
							type="text" name="feedback4" path="question4" class="form-control"
							required="required" /></td>
				</tr>
				<tr>
					<td><b>Question 5:</b> <f:input style="width: 350px;" type="text" name="feedback5"
